...
def bbox_XIoU(box1, box2, xywh=True, GIoU=False, DIoU=False, XIoU=False, CIoU=False, eps=1e-7):
    """
...
def bbox_iou_improve(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False,
                     Focal=False, MPDIou=True,
