...
class TaskAlignedAssigner(nn.Module):
    ...
    def get_box_metrics(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes, mask_gt):
        ...
        # overlaps[mask_gt] = bbox_iou_improve(gt_boxes, pd_boxes, xywh=False, MPDIou=True).squeeze(-1).clamp_(0)
        # overlaps[mask_gt] = bbox_iou(gt_boxes, pd_boxes, xywh=False, GIoU=True).squeeze(-1).clamp(0)
