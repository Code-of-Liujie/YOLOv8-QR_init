...
from ultralytics.utils.metrics import OKS_SIGMA,bbox_XIoU
...
from .metrics import bbox_iou,bbox_iou_improve
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = bbox_iou_improve(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, CIoU=True)
        nwd = torch.exp(
    ...
    def _df_loss(pred_dist, target):
        """Return sum of left and right DFL losses."""  # Distribution Focal Loss (DFL) proposed in Generalized Focal Loss https://ieeexplore.ieee.org/document/9792391
