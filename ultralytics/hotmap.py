...
def get_params():
    params = {
        'weight': r"E:\\DCNV3\\ultralytics-main\\ultralytics\\models\\yolo\\detect\\runs\\detect\\train293\\weights\\best.pt",
        'cfg': r'E:\\DCNV3\\ultralytics-main\\ultralytics\\cfg\models\\v8\yolov8.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r"E:\data\train\images\403.bmp", "E:\\result\\result\\ob5")